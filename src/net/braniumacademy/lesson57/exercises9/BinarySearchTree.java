package net.braniumacademy.lesson57.exercises9;

public class BinarySearchTree<T extends Number> {
    private Node<T> root;

    public int removeNodes() {
        var targetNodes = firstLeftNodeWithOneChildren(root.leftNode);
        if(targetNodes != null) {
            remove(targetNodes);
        }
    ...
    private T firstLeftNodeWithOneChildren(Node<T> r) {
        if (r == null) {
        ...
        return firstLeftNodeWithOneChildren(r.leftNode);
    }
