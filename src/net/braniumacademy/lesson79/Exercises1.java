package net.braniumacademy.lesson79;
...
public class Exercises1 {
    public static void main(String[] args) {
        HashMap<String, Student> hashMap = new HashMap<>(100); // 1
        ...
        do {
            ...
            switch (choice) {
                case 1: // test phương thức put()4 và addEntry()2
                    ...
                    hashMap.put(id, new Student(id, first, last, mid, gpa));
                    break;
                ...
                case 4: // test phương thức containsValue(value)5
                    if (!hashMap.isEmpty()) {
                        ...
                        var checkStudent = hashMap.containsValue(newStudent);
                        if (checkStudent) {
                    ...
                    break;
                case 5: // test phương thức containsKey(key)6
                    if (!hashMap.isEmpty()) {
                        System.out.println("Nhập mã sinh viên cần tìm: ");
                        id = input.nextLine();
                        var checkKey = hashMap.containsKey(id);
                        if (checkKey) {
                            System.out.printf("Tồn tại sinh viên mã \"%s\"\n", id);
                        } else {
                            System.out.printf("Không tồn tại sinh viên mã \"%s\"\n", id);
                    ...
                    break;
                case 6: // test phương thức isEmpty()7
                    System.out.println(hashMap.isEmpty() ? "Rỗng" : "Không rỗng.");
                    break;
                case 7: // test phương thức size()8
                    System.out.println("Số phần tử hiện có trong bảng băm: " + hashMap.size());
                    break;
                case 8: // test phương thức remove(key)9
                    if (!hashMap.isEmpty()) {
                        System.out.println("Nhập mã sinh viên cần xóa: ");
                        id = input.nextLine();
                        var removeStudent = hashMap.remove(id);
                ...
                case 9: // test phương thức replace(key, value) 10
                    ...
                    break;
                case 10: // test phương thức keySet()11
                    if (!hashMap.isEmpty()) {
                    ...
                    break;
                case 11: // test phương thức values()12
                    if (!hashMap.isEmpty()) {
                        System.out.println("Các Sinh viên hiện có trong bảng băm: ");
                        var studentsInHashTable = hashMap.values();
                    ...
                    break;
                case 12: // test phương thức clear()13
                    if (!hashMap.isEmpty()) {
