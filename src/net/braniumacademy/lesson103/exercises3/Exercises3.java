...
import net.braniumacademy.lesson103.exercises2.Exercises2;
...
public class Exercises3 {
    ...
    public static void bfs(Vertex[] vertices, boolean[][] adjMatrix, int v) {
        ...
        while (!queue.isEmpty()) {
            v = queue.dequeue();
            System.out.printf("%c ", vertices[v].label);
    ...
    public static void main(String[] args) throws FileNotFoundException {
        var pathName = "./src/net/braniumacademy/lesson103/exercises3/input.dat";
