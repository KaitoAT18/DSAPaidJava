...
public class Exercises4 {
    public static void main(String[] args) {
        ...
        Vector<BankAccount> listAcc = new Vector<>();
    ...
    private static void showListElements(Vector<BankAccount> listAcc) {
        for (var e : listAcc) {
            showBankAccInfo(e);
        }
    }
    ...
    private static void createFakeData(Vector<BankAccount> listAcc) {
        SimpleDateFormat dateFormat = new SimpleDateFormat("dd/MM/yyyy");
        Scanner input;
        try {
